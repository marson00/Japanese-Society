        ...
        <div id="content">
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <?php
                    ...
                    $sql = "SELECT COUNT(*) AS cntrows FROM user_member WHERE user_type = 1";
                    ...
                    // fetch rows
                    $sql = "SELECT * FROM user_member WHERE user_type = 1 ".$orderby." limit $row,".$rowperpage;
                    $result = mysqli_query($con,$sql);
                    $sno = $row + 1;
                ...
                ?>
                <tr>
                    <td colspan="6" align='center' class="align-middle p-2">Showing <?php echo $sno = $sno - 1; ?> out of <?php echo $allcount ?> records</td>
                    <td class="p-2"><a href="../customerSide/register.php" ><button type="button" class="btn btn-primary" style="font-size:13px;">Add new member</button></a></td>
                </tr>
            </table>
